...
internal static class Program
{
    ...
    private static void WriteToolError(string message) => Console.Error.WriteLine($"dotnet-textresources: {message}");

    private static void WriteUsage(TextWriter writer)
    {
        writer.WriteLine("Usage:");
        writer.WriteLine("  dotnet-textresources validate --catalog <file> --documents <path-or-glob...>");
        writer.WriteLine("  dotnet-textresources generate --catalog <file> --documents <path-or-glob...> --output <directory> [emit-switches]");
        writer.WriteLine("  dotnet-textresources verify --catalog <file> --documents <path-or-glob...> --output <directory> [emit-switches]");
        writer.WriteLine("  dotnet-textresources schema --output <directory>");
        writer.WriteLine();
