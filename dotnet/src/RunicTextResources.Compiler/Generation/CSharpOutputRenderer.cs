...
internal static class CSharpOutputRenderer
{
    ...
    internal static TextResourceGeneratedOutput RenderAccessors(CompiledTextCatalog catalog)
    {
        ...
        {
            writer.Line("private readonly global::RunicTextResources.ITextResourceManager " + rootManagerField + ";");
            writer.Blank();
        }
        writer.Line("/// <summary>Creates accessors over a locale manager.</summary>");
        writer.Line("public " + className + "(global::RunicTextResources.ITextResourceManager manager)");
        writer.Line("{");
        writer.Indent();
    ...
    internal static TextResourceGeneratedOutput RenderCatalogData(CompiledTextCatalog catalog)
    {
        ...
        writer.Blank();
        writer.Line("internal static global::RunicTextResources.CompiledTextResourceCatalog CreateDefinition()");
        writer.Line("{");
        writer.Indent();
        writer.Line("return new global::RunicTextResources.CompiledTextResourceCatalog(");
        writer.Indent();
        ...
        writer.Line("global::RunicTextResources.UnsupportedLocalePolicy." + catalog.UnsupportedLocale + ",");
        writer.Line("global::RunicTextResources.MissingTextResourcePolicy." + catalog.MissingKey + ");");
        writer.Unindent();
        writer.Unindent();
        writer.Line("}");
        writer.Blank();
    ...
    internal static TextResourceGeneratedOutput RenderRegistration(CompiledTextCatalog catalog)
    {
        ...
        writer.Line("public static global::RunicTextResources.ITextResourceProvider CreateProvider(");
        writer.Indent();
        writer.Line("global::RunicTextResources.ITextValueFormatter? valueFormatter = null,");
        writer.Line("global::RunicTextResources.ITextResourceSnapshotFactory? snapshotFactory = null,");
        writer.Line("global::RunicTextResources.TextResourceOptions? options = null)");
        writer.Unindent();
        writer.Line("{");
        writer.Indent();
        writer.Line("if (global::RunicTextResources.TextResourcesCompatibility.RuntimeAbiVersion != RuntimeAbiVersion)");
        writer.Indent();
        writer.Line("throw new global::System.InvalidOperationException(\"RTR0024: Generated text-resource code is incompatible with the referenced runtime ABI.\");");
        writer.Unindent();
        writer.Line("return new global::RunicTextResources.CompiledTextResourceProvider(" + className + "CatalogData.CreateDefinition().WithOptions(options), valueFormatter, snapshotFactory);");
        writer.Unindent();
        writer.Line("}");
        writer.Blank();
        writer.Line("/// <summary>Creates a manager after asynchronously resolving its initial immutable snapshot.</summary>");
        writer.Line("public static async global::System.Threading.Tasks.ValueTask<global::RunicTextResources.ITextResourceManager> CreateManagerAsync(");
        writer.Indent();
        ...
        writer.Line("{");
        writer.Indent();
        writer.Line("global::RunicTextResources.ITextResourceProvider provider = CreateProvider(valueFormatter, snapshotFactory, options);");
        writer.Line("global::RunicTextResources.ITextResourceSnapshot snapshot = await provider.GetSnapshotAsync(initialLocale ?? DefaultLocale, cancellationToken).ConfigureAwait(false);");
        writer.Line("return new global::RunicTextResources.TextResourceManager(provider, snapshot);");
        writer.Unindent();
        writer.Line("}");
        writer.Blank();
        writer.Line("/// <summary>Creates a provider that composes verified caller-supplied packs over compiled snapshots.</summary>");
        writer.Line("public static global::RunicTextResources.ITextResourceProvider CreateExternalProvider(");
        writer.Indent();
        writer.Line("global::RunicTextResources.IExternalTextResourceSource externalSource,");
        writer.Line("global::RunicTextResources.TextResourceOptions? options = null,");
        writer.Line("global::RunicTextResources.ITextValueFormatter? valueFormatter = null,");
        writer.Line("global::RunicTextResources.TextResourcePackLimits? limits = null,");
        writer.Line("global::RunicTextResources.TextResourcePackIntegrityVerifier? integrityVerifier = null)");
        writer.Unindent();
        writer.Line("{");
        writer.Indent();
        writer.Line("var factory = new global::RunicTextResources.ExternalTextResourceSnapshotFactory(externalSource, CatalogId, ContractFingerprint, CreateExternalPackContract, limits, integrityVerifier);");
        ...
        writer.Line("public static async global::System.Threading.Tasks.ValueTask<global::RunicTextResources.ITextResourceManager> CreateExternalManagerAsync(");
        writer.Indent();
        writer.Line("global::RunicTextResources.IExternalTextResourceSource externalSource,");
        writer.Line("string? initialLocale = null,");
        writer.Line("global::RunicTextResources.TextResourceOptions? options = null,");
        ...
        writer.Line("{");
        writer.Indent();
        writer.Line("global::RunicTextResources.ITextResourceProvider provider = CreateExternalProvider(externalSource, options, valueFormatter, limits, integrityVerifier);");
        writer.Line("global::RunicTextResources.ITextResourceSnapshot snapshot = await provider.GetSnapshotAsync(initialLocale ?? DefaultLocale, cancellationToken).ConfigureAwait(false);");
        writer.Line("return new global::RunicTextResources.TextResourceManager(provider, snapshot);");
        writer.Unindent();
        writer.Line("}");
        ...
        writer.Line("public static global::RunicTextResources.TextResourcePackContract CreateExternalPackContract(string locale)");
        writer.Line("{");
        writer.Indent();
        ...
        writer.Line("public static global::System.Threading.Tasks.ValueTask<global::RunicTextResources.VerifiedExternalTextResourcePack?> LoadExternalPackAsync(");
        writer.Indent();
        writer.Line("global::RunicTextResources.IExternalTextResourceSource source,");
        ...
        writer.Line("{");
        writer.Indent();
        writer.Line("return global::RunicTextResources.TextResourcePackLoader.LoadAsync(source, CreateExternalPackContract(locale), limits, integrityVerifier, cancellationToken);");
        writer.Unindent();
        writer.Line("}");
        writer.Unindent();
        writer.Line("}");
    ...
    private static void WriteKeyMembers(GenerationWriter writer, CompiledTextCatalog catalog, ResourceTreeNode node)
    {
        foreach (KeyValuePair<string, ResourceTreeNode> child in node.Children)
        {
            if (child.Value.Resource is not null)
            {
                ...
                writer.Line("public static global::RunicTextResources.TextResourceKey " + GenerationSupport.CSharpIdentifier(child.Key) + " { get; } = new global::RunicTextResources.TextResourceKey(" + GenerationSupport.CSharpString(catalog.Id) + ", " + resource.Id + ", " + GenerationSupport.CSharpString(resource.Key) + ");");
            }
            else
            {
    ...
    private static void WriteAccessorMembers(GenerationWriter writer, ResourceTreeNode node, string keyPath, string managerField)
    {
        ...
        foreach (KeyValuePair<string, ResourceTreeNode> child in node.Children)
        {
            ...
            {
                writer.Line("private readonly global::RunicTextResources.ITextResourceManager " + childManagerField + ";");
                writer.Blank();
            }
            writer.Line("internal " + identifier + "Group(global::RunicTextResources.ITextResourceManager manager)");
            writer.Line("{");
            writer.Indent();
    ...
    {
        writer.Line("new global::RunicTextResources.CompiledTextResourceDefinition[]");
        writer.Line("{");
        writer.Indent();
        for (int i = 0; i < definitions.Count; i++)
        {
            ...
            IReadOnlyList<CompiledTextPlaceholder> placeholders = GenerationSupport.OrderedPlaceholders(resource.Placeholders);
            writer.Line("new global::RunicTextResources.CompiledTextResourceDefinition(" + GenerationSupport.CSharpString(resource.Key) + ", new global::RunicTextResources.TextResourcePlaceholderDescriptor[]");
            writer.Line("{");
            writer.Indent();
            for (int placeholderIndex = 0; placeholderIndex < placeholders.Count; placeholderIndex++)
            {
                ...
                writer.Line("new global::RunicTextResources.TextResourcePlaceholderDescriptor(" + GenerationSupport.CSharpString(placeholder.Name) + ", global::RunicTextResources.TextArgumentType." + GenerationSupport.ArgumentTypeName(placeholder.Type) + ", global::RunicTextResources.TextArgumentFormat." + GenerationSupport.ArgumentFormatName(placeholder.Format) + "),");
            }
            writer.Unindent();
    ...
    {
        writer.Line("new global::RunicTextResources.CompiledTextResourceLocale[]");
        writer.Line("{");
        writer.Indent();
        for (int i = 0; i < locales.Count; i++)
        {
            ...
            writer.Line("new global::RunicTextResources.CompiledTextResourceLocale(" + GenerationSupport.CSharpString(locale.Tag) + ", " + (locale.FallbackTag is null ? "null" : GenerationSupport.CSharpString(locale.FallbackTag)) + ", new global::RunicTextResources.CompiledTextResourceValue[]");
            writer.Line("{");
            writer.Indent();
    ...
    {
        writer.Line("internal static global::RunicTextResources.TextResourcePackContract CreateExternalPackContract(string locale)");
        writer.Line("{");
        writer.Indent();
        ...
        CompiledTextLocale locale)
    {
        ...
        writer.Line("return new global::RunicTextResources.TextResourcePackContract(");
        writer.Indent();
        writer.Line(GenerationSupport.CSharpString(catalog.Id) + ",");
        writer.Line(GenerationSupport.CSharpString(locale.Tag) + ",");
        writer.Line(GenerationSupport.CSharpString(catalog.Fingerprint) + ",");
        writer.Line("new global::RunicTextResources.TextResourcePackMessageContract[]");
        writer.Line("{");
        writer.Indent();
        for (int i = 0; i < selectedDefinitions.Count; i++)
        {
            ...
            writer.Line("new global::RunicTextResources.TextResourcePackMessageContract(");
            writer.Indent();
            writer.Line("new global::RunicTextResources.TextResourceKey(" + GenerationSupport.CSharpString(catalog.Id) + ", " + definition.Id + ", " + GenerationSupport.CSharpString(resource.Key) + "),");
            writer.Line("new global::RunicTextResources.TextResourcePackArgumentContract[]");
            writer.Line("{");
            writer.Indent();
            for (int placeholderIndex = 0; placeholderIndex < placeholders.Count; placeholderIndex++)
            {
                CompiledTextPlaceholder placeholder = placeholders[placeholderIndex];
                writer.Line("new global::RunicTextResources.TextResourcePackArgumentContract(" + GenerationSupport.CSharpString(placeholder.Name) + ", global::RunicTextResources.TextArgumentType." + GenerationSupport.ArgumentTypeName(placeholder.Type) + ", global::RunicTextResources.TextArgumentFormat." + GenerationSupport.ArgumentFormatName(placeholder.Format) + "),");
            }
            writer.Unindent();
            writer.Line("}),");
            writer.Unindent();
