...
{
    private const string JournalFileName = ".runic-textresources.transaction.json";
    ...
    private sealed record TransactionJournal(int Version, string Root, string CatalogId, JournalEntry[] Entries);
    private sealed record JournalEntry(string Path, string? TemporaryName, string? OriginalBase64, bool Delete, string? NewRevision);
