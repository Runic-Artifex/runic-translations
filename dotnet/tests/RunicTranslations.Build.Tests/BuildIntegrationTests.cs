...
internal static class BuildIntegrationTests
{
    ...
    private static void TargetDeclaresInputsAndOutputs()
    {
        string targetsPath = RepositoryPaths.Resolve(
            ...
            "build",
            "RunicTranslations.Build.targets");
        ...
        string? toolCommand = null)
    {
        ...
        string props = XmlPath(RepositoryPaths.Resolve("dotnet", "src", "RunicTranslations.Build", "build", "RunicTranslations.Build.props"));
        string targets = XmlPath(RepositoryPaths.Resolve("dotnet", "src", "RunicTranslations.Build", "build", "RunicTranslations.Build.targets"));
