...
internal static class WaveCAssetManifestTests
{
    ...
    private static void SelectedOutputCombinations()
    {
        ...
        Assert.Equal("RunicTranslations.WaveC.Conformance", index.RootElement.GetProperty("identity").GetString());
        ...
        Assert.Equal("RunicTranslations.WaveC.AssetManifest", root.GetProperty("identity").GetString());
