...
internal static class EditorStateTests
{
    ...
    {
        using TemporaryDirectory directory = new();
        string sidecar = System.IO.Path.Combine(directory.Path, ".runic-textresources", "product.editor-state.json");
    ...
    private static void Hostile()
    {
        ...
        File.WriteAllText(sidecar,
            """{"$schema":"runic.textresources.editor-state/1","catalog":"product","catalog":"other","messages":{},"terminology":[]}""",
