...
using System.IO;
using System.Text;
using AnalysisModel = RunicTranslations.Compiler.Analysis;
using CompilerModel = RunicTranslations.Compiler;
...
internal static class AnalysisTests
{
    ...
    {
        string path = RepositoryPaths.Resolve("dotnet", "tests", "RunicTranslations.Compiler.Tests", "Golden", fileName);
