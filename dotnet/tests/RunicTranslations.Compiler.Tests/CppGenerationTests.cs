    ...
    private static void Compiles()
    {
        ...
        try
        {
            ...
            File.WriteAllText(Path.Combine(directory, "main.cpp"), """
                ...
                #include <iostream>
                int main() {
                  using namespace runic_translations::catalog_minimal;
                  std::cout << m_5Hello("en");
                }
                """, new UTF8Encoding(false));
            Run(directory, "clang++", "-std=c++20", "-Wall", "-Wextra", "-Werror", "minimal.translations-v1.cpp", "main.cpp", "-o", "test");
    ...
    private static void CompilesV2Selectors()
    {
        ...
        try
        {
            ...
            File.WriteAllText(Path.Combine(directory, "main.cpp"), """
                ...
                #include <iostream>
                int main() {
                  using namespace runic_translations::catalog_cppv2;
                  std::cout << m_6Result("en", m_6Result_args{2, "guest"});
                }
                """, new UTF8Encoding(false));
            Run(directory, "clang++", "-std=c++20", "-Wall", "-Wextra", "-Werror", "cppv2.translations-v1.cpp", "main.cpp", "-o", "test");
