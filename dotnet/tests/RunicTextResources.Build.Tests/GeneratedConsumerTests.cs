...
internal static class GeneratedConsumerTests
{
    ...
    private static void GeneratedCodeCompilesAndRuns()
    {
        ...
        File.WriteAllText(
            ...
            "using RunicTextResources.Examples.Localization;\n" +
            "RunicTextResources.ITextResourceManager manager = await MinimalTextCatalog.CreateManagerAsync();\n" +
