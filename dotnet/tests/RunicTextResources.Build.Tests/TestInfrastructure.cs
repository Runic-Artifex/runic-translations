...
internal static class RepositoryPaths
{
    ...
    public static string ToolAssembly
    {
        get
        {
            ...
            return Resolve("dotnet", "tools", "RunicTextResources.Tool", "bin", configuration, "net10.0", "RunicTextResources.Tool.dll");
        }
    }
...
internal sealed class TemporaryDirectory : IDisposable
{
    ...
    {
        Path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), $"runic-text-resources-{Guid.NewGuid():N}");
