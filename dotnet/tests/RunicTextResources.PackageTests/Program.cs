...
using RunicTextResources.PackageConsumer;

namespace RunicTextResources.PackageTests;
...
internal static class Program
{
    ...
    private static string? ParseFeed(string[] args)
    {
        ...
        {
            throw new ArgumentException("Usage: RunicTextResources.PackageTests [--feed <directory>]");
        }
    ...
    private static void InspectPackages(string feed)
    {
        ...
        AssertPackageShape(runtime,
            ...
            "README.md",
            "lib/net10.0/RunicTextResources.dll",
            "lib/net10.0/RunicTextResources.xml");
        ...
        AssertPackageShape(build,
            ...
            "README.md",
            "build/RunicTextResources.Build.props",
            "build/RunicTextResources.Build.targets");
        AssertPackageShape(generator,
            "RunicTextResources.Generator.nuspec",
            "README.md",
            "analyzers/dotnet/cs/RunicTextResources.Generator.dll",
            "analyzers/dotnet/cs/RunicTextResources.Compiler.dll");
        AssertPackageShape(tool,
            "RunicTextResources.Tool.nuspec",
            "README.md",
