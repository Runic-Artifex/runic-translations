...
internal static class WaveCAssetManifestTests
{
    ...
    private static void SelectedOutputCombinations()
    {
        ...
        Assert.Equal("Runic.Translations.WaveC.Conformance", index.RootElement.GetProperty("identity").GetString());
        ...
        Assert.Equal("Runic.Translations.WaveC.AssetManifest", root.GetProperty("identity").GetString());
