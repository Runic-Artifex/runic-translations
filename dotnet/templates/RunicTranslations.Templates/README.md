...
dotnet new runic-translations --output Resources --catalog product --defaultLocale de --namespace Customer.Product --className ProductText
dotnet new runic-translations-project --name Customer.Product.Text --catalog product --defaultLocale de --namespace Customer.Product --className ProductText
```
...
`RunicTranslations.Build`. The project template includes the runtime, generator,
