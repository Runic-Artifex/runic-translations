...
internal static class GeneratorTests
{
    ...
    internal static void Register(TestRunner runner)
    {
        ...
        runner.Add("mismatched runtime ABI reports WUTTEXT0024", MismatchedRuntimeAbi);
        runner.Add("missing runtime ABI reports WUTTEXT0024", MissingRuntimeAbi);
    ...
    private static void ExactDiagnosticLocation()
    {
        ...
        Diagnostic diagnostic = run.SingleResult.Diagnostics.Single(static item => item.Id == "WUTTEXT0006");
    ...
    private static void PathsAreNormalized()
    {
        ...
        Diagnostic diagnostic = run.SingleResult.Diagnostics.Single(static item => item.Id == "WUTTEXT0001");
    ...
    private static void MismatchedRuntimeAbi()
    {
        GeneratorRun run = GeneratorTestHost.Run(
            ...
            new TestInput("C:/repo/Resources/app.textcatalog.json", "Catalog", Catalog),
            new TestInput("C:/repo/Resources/en.texts.json", "Document", Document));
        Diagnostic diagnostic = run.SingleResult.Diagnostics.Single(static item => item.Id == "WUTTEXT0024");
        Assert.Equal(
            "Referenced WebUIToolkit.TextResources runtime ABI version 2 is incompatible with generated ABI version 1.",
    ...
    private static void WindowsDeviceHintStem()
    {
        ...
        Diagnostic diagnostic = run.SingleResult.Diagnostics.Single(static item => item.Id == "WUTTEXT0018");
        FileLinePositionSpan span = diagnostic.Location.GetLineSpan();
