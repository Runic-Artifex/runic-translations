...
using WebUIToolkit.TextResources.PackageConsumer;

namespace WebUIToolkit.TextResources.PackageTests;
...
internal static class Program
{
    ...
    private static string? ParseFeed(string[] args)
    {
        ...
        {
            throw new ArgumentException("Usage: WebUIToolkit.TextResources.PackageTests [--feed <directory>]");
        }
    ...
    {
        string runtime = RequireSingle(feed, "WebUIToolkit.TextResources.1.0.0.nupkg");
        string compiler = RequireSingle(feed, "WebUIToolkit.TextResources.Compiler.1.0.0.nupkg");
        string build = RequireSingle(feed, "WebUIToolkit.TextResources.Build.1.0.0.nupkg");
        string generator = RequireSingle(feed, "WebUIToolkit.TextResources.Generator.1.0.0.nupkg");
        string tool = RequireSingle(feed, "WebUIToolkit.DotNet.TextResources.1.0.0.nupkg");
        ...
        AssertPackageShape(build,
            ...
            "README.md",
            "build/WebUIToolkit.TextResources.Build.props",
            "build/WebUIToolkit.TextResources.Build.targets");
        AssertPackageShape(generator,
            "WebUIToolkit.TextResources.Generator.nuspec",
            "README.md",
            "analyzers/dotnet/cs/WebUIToolkit.TextResources.Generator.dll",
            "analyzers/dotnet/cs/WebUIToolkit.TextResources.Compiler.dll");
        ...
        AssertDependencies(generator, ["WebUIToolkit.TextResources"]);
